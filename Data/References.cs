    ...
    public static class References
    {
        public static Reference MichaelRentMeister
        {
            get =>
                new Reference()
                {
                    ...
                    LinkedInPicture = "https://media-exp1.licdn.com/dms/image/C5603AQE2Drx9iwq8ow/profile-displayphoto-shrink_200_200/0/1631728685797?e=1642032000&v=beta&t=0RslN6jkleYZPHz9auIzMaF9x5Is9VLCWuaGup1f-w8",
                    Description = @"I worked with Michael in the Camps Project.  He has seem me under the toughest working conditions, and stress. 
        ...
        public static Reference MikeThorup
        {
            get =>
                new Reference()
                {
                    ...
                    LinkedInPicture = "https://media-exp1.licdn.com/dms/image/C4E03AQFllhA7f7FqDw/profile-displayphoto-shrink_200_200/0/1546816044395?e=1642032000&v=beta&t=dXnHlMJRWDKQNFFBWUSUbsNdIiQUbul6FlCeToLb2zk",
        ...
        public static Reference GreggBJensen
        {
            get =>
                new Reference()
                {
                    ...
                    LinkedInPicture = "https://media-exp1.licdn.com/dms/image/C4E03AQHwaU_FpO-YtQ/profile-displayphoto-shrink_200_200/0/1584639543708?e=1642032000&v=beta&t=g4-Int7fQU2A3aG2m2ARozlsSvwGhrYNoDzHQqLw3-E",
        ...
        public static Reference DarrenDOrlando
        {
            get =>
                new Reference()
                {
                    ...
                    LinkedInPicture = "https://media-exp1.licdn.com/dms/image/C4E03AQH_FniG--fZ9g/profile-displayphoto-shrink_200_200/0/1609714568213?e=1642032000&v=beta&t=5AfrNfNkM0-1cwmQ_hwgpXHHt-DhcgsVmB-7wdD1nB8",
        ...
        public static Reference NickoleSkembo
        {
            get =>
                new Reference()
                {
                    ...
                    LinkedInPicture = "https://media-exp1.licdn.com/dms/image/C5603AQGAZfPJproj0A/profile-displayphoto-shrink_200_200/0/1628527956161?e=1642032000&v=beta&t=vq79TQOyZHT7A2RJPYToqoHGBm69f_AdxL8MswO13FQ",
        ...
        public static Reference DanWoodruff
        {
            get =>
                new Reference()
                {
                    ...
                    LinkedInPicture = "https://media-exp1.licdn.com/dms/image/C5603AQE9OXGuMXhHnQ/profile-displayphoto-shrink_200_200/0/1563027048759?e=1642032000&v=beta&t=hogfibKGmGht6004IkvtmSr8Xig6fvwuxWX0Ki5vi38",
        ...
        public static Reference JaredBrokaw
        {
            get =>
                new Reference()
                {
                    ...
                    LinkedInPicture = "https://media-exp1.licdn.com/dms/image/C4E03AQEkeiFZya6f0A/profile-displayphoto-shrink_200_200/0/1542820068562?e=1642032000&v=beta&t=xPRajUZ5ltwz4r64VS_oOVL2D6_ef9U6ozpjhLJc4Xo",
        ...
        public static Reference RandiLehman
        {
            get =>
                new Reference()
                {
                    ...
                    LinkedInPicture = "https://media-exp1.licdn.com/dms/image/C4D03AQHldoWI3mQAlg/profile-displayphoto-shrink_200_200/0/1516269099851?e=1642032000&v=beta&t=F6g5zlAp2C9PofKcyNZS8vqWSKTrC4jqOnP9d8qbPxQ",
        ...
        public static Reference MarkHerpel
        {
            get =>
                new Reference()
                {
                    ...
                    LinkedInPicture = "https://media-exp1.licdn.com/dms/image/C4D03AQEjl6TRrSjX1w/profile-displayphoto-shrink_200_200/0/1517262252031?e=1642032000&v=beta&t=shAcy2WOZ6Jjf959_NZJ8TjReVVMjqB9dr2mKSbxNA0",
        ...
        public static Reference HughMcKee
        {
            get =>
                new Reference()
                {
                    ...
                    LinkedInPicture = "https://media-exp1.licdn.com/dms/image/C5603AQGfpUEv2zB8Qg/profile-displayphoto-shrink_200_200/0/1517562276977?e=1642032000&v=beta&t=qyqOpZPAxVT2I8YXCWncr2qyJn3EQWLhnoJ3qs8VKLQ",
        ...
        public static Reference NathanBroadhead
        {
            get =>
                new Reference()
                {
                    ...
                    LinkedInPicture = "https://media-exp1.licdn.com/dms/image/C4E03AQE_IjJ4dy5aOw/profile-displayphoto-shrink_200_200/0/1520563624380?e=1642032000&v=beta&t=gMfg3fx-K_SXMw1xiUNxRz5jPiHJymsr0UDl_zIKfbc",
        ...
        public static Reference JEricThopmson
        {
            get =>
                new Reference()
                {
                    ...
                    LinkedInPicture = "https://media-exp1.licdn.com/dms/image/C4E03AQFgA1DpShPUYg/profile-displayphoto-shrink_200_200/0/1609956439214?e=1642032000&v=beta&t=3mCyjfQo1_FAbVyjYPbBPUy9zKDhH0wW09s97ZjTha4",
        ...
        public static Reference MarcJohnson
        {
            get =>
                new Reference()
                {
                    ...
                    LinkedInPicture = "https://media-exp1.licdn.com/dms/image/C5603AQHI3-jPA07tNw/profile-displayphoto-shrink_200_200/0/1520863980432?e=1642032000&v=beta&t=S_JJQrLDRtUF4DkzVpd98S4vQ5fpOdAwrNGV4CtuPFc",
        ...
        typeof(References)
            ...
            .Where(p =>
                        ...
                        p.GetValue(null).GetType().Equals(typeof(Reference)))
            .Select(p => (Reference)p.GetValue(null))
            .ToList();
    }
}